...
import tn.esprit.spring.models.MissionModel;
...
public class RestControlTimesheet {
	...
	@ResponseBody
	public int ajouterMission(@RequestBody MissionModel mission) {
		itimesheetservice.ajouterMission(mission.toEntity());
		return mission.toEntity().getId();
	}
